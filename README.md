...
The tool is not downloadable.

It is deployed via Docker on the XNAT instance where the data resides.

Pull the correct Docker image inside your XNAT environment:

Individual scan level: iqaxnat_scan:latest

Subject-level analysis: iqaxnat_subject:latest
